...
public class DateTimeSettingDialogFragment extends DialogFragment implements WebAPIResultListener, View.OnClickListener{
    ...
    public Dialog onCreateDialog(Bundle arguments) {
        ...
        items.add("+");
        items.add("-");
        ArrayAdapter<String> adapter = new ArrayAdapter<>(getActivity(), android.R.layout.simple_spinner_item, items.toArray(new String[0]));
        ...
        mOnDateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                String text = year + "-" + String.format(Locale.US, "%02d", (monthOfYear + 1)) + "-" + String.format(Locale.US, "%02d", dayOfMonth);
        ...
        mOnTimeSetListener = new TimePickerDialog.OnTimeSetListener() {
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                String text = String.format(Locale.US, "%02d", hourOfDay) + ":" + String.format(Locale.US, "%02d", minute) + ":00";
        ...
        if (v != null) {
            if(v.getId() == R.id.DateEditButton) {
                ...
                DatePickerDialog dateDialog = new DatePickerDialog(
                        ...
                        day);
                dateDialog.show();
            }else if(v.getId() == R.id.TimeEditButton) {
                ...
                switch (result.getRequestCode()) {
                    case GET_FUNCTIONS_DATETIME:
                        ...
                        if (m.find()) {
                            ...
                            String dateText = m.group(3) + "-" + month + "-" + m.group(1);
                            ...
                            mDstCheckBox.setChecked(Boolean.parseBoolean(result.getResponseBodyFromKey("dst")));
                        }
                        break;
    ...
    private void setDateTime(){
        ...
        String month = MONTH_ITEMS[Integer.parseInt(date[1]) - 1];
        String year = date[0];
